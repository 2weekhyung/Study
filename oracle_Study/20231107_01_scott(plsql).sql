...
--    SQL 문 실행 후 오직 하나의 행(ROW)만 출려하게 된다.
...
CREATE [OR REPLACE] TRIGGER 트리거명
    ...
    [[FOR EACH ROW] [WHEN TRIGGER 조건]] // FOR EACH ROW 생략 가능
[DECLARE]
    -- 선언 구문;
BEGIN
    -- 실행 구문;
