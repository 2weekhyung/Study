...
FROM DUAL;
--==>> 에러 발생
-- (ORA-00904: "오라클 수업": invalid identifier)
...
--○ 오라클 사용자 계정 생성
CREATE USER jhu IDENTIFIED BY java006$
DEFAULT TABLESPACE TBS_EDUA;
--==>> User JHU이(가) 생성되었습니다.
--> jhu 라는 사용자 계정을 생성하겠다. (만들겠다. 만들어줘.)
-- 이 사용자의 계정의 패스워드는 java006$ 로 하겠다.
