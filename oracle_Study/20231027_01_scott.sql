...
--① MAX 사용
SELECT EMPNO "사원번호", ENAME "사원명", DEPTNO "부서번호", JOB "직종명", NVL(COMM,0) "수당"
FROM TBL_EMP
...
SELECT EMPNO "사원번호", ENAME "사원명", DEPTNO "부서번호", JOB "직종명", COMM "수당"
FROM TBL_EMP
WHERE COMM,0) >= ALL(NULL, 300, 500, NULL, 1400, NULL, NULL, NULL, NULL, 0);
--==>> 조회 결과 없음
...
SELECT EMPNO, ENAME, JOB
FROM TBL_EMP
WHERE EMPNO IN (7902, 7968, 7698, 7839, 7698, 7839, 7839, 7566, NULL, 7698, 7788, 7698, 7566, 7782);
--==>>
/*
7566	JONES	MANAGER
7698	BLAKE	MANAGER
...
SELECT EMPNO, ENAME, JOB
FROM TBL_EMP
WHERE EMPNO IN (7902, 7968, 7698, 7839, 7566, NULL, 7788, 7782);
