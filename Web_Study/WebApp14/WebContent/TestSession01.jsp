...
<!--
	○ TestSession01.jsp 에서 TestSession02.jsp 페이지로
	   ...
	   ※ 즉, 01 에서 02로 넘겨받을 땐 getParameter
	      02 에서 03으로 넘겨 받을 땐 getParameter 와 getAttribute 로 세션 활용
...
<div>
	<form action="TestSession02.jsp" method="post">
		<table class="table">
			...
			<tr>
				<td colspan="2">
					<button type="button" class="btn" onclick="sendIt()" style="width: 400px; height: 40px; font-size: 17pt;">다음 페이지로 전송</button>
				</td>
			</tr>
		</table>
	</form>
