...
public class MVCBegin extends HttpServlet
{
	...
	// 사용자의 http 프로토콜 요청이 GET 방식일 경우 호출되는 방식
	@Override
	...
	// 사용자의 http 프로토콜 요청이 POST 방식일 경우 호출되는 방식
	@Override
	...
	protected void doGetPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String message = "안녕하세요, MBC 패턴입니다~!!!";
		...
		//   현재 클라이언트의 요청을 다름 서블릿/JSP 페이지로 전달하거나
		...
		// ==> 웹 기반 모델2(MVC) 구조는
		//     바로 이 『RequsetDispatcher』 의 『forward()』
		//     메소드를 통해 구현된다.
