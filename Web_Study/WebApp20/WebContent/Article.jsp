...
<%@page import="javafx.scene.chart.BubbleChart"%>
...
<script type="text/javascript">
	...
	{	
		...
		var pwd = prompt("게시물의 비밀번호를 입력해 주세요", "");
...
<div id="bbs">
	...
	<div id="bbsArticle_footer">
		...
		<div id="leftFooter">
			...
			<!-- <input type="button" value="삭제" class="btn2" onclick="test()"> -->
		...
		<div id="rightFooter">
			<%-- <input type="button" value="리스트" class="btn2" onclick="javascript:location.href='<%=cp%>/List.jsp?pageNum=1'"> --%>
