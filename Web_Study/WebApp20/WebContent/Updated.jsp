...
<style type="text/css">
	#pwd{background-color: #eeffee;}
	/* #pwd{border-color: red; border: 2px;} */
</style>
...
<script type="text/javascript">
	...
	{	
		...
		// 입력을 한 상황이라면, 이메일 형식에 맞게 입력햇는지 확인하는 처리
		...
		// 해당 게시물 작성시 설정한 패스워드와
		// 게시물을 수정하는 과정에서 입력한 패스워드가
		// 서로 일치하는지를 확인하여 액션 처리 수행여부 판단
	...
	<form action="" method="post" name="myForm">
		...
		<div id="bbsCreated">
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						%>
							<input type="text" name="subject" size="64" 
							maxlength="100" class="boxTF" value="<%=dto.getSubject()%>" disabled="disabled">
						<%
						}
						%>
					</dd>
				...
				<dl>
					...
					<dd>
						...
						%>
							...
							<input type="email" name="email" size="35"
							maxlength="50" class="boxTF" value="<%=emailStr%>" disabled="disabled">
						<%
						}
						%>
					</dd>
			...
			<div class="bbsCreated_noLine">
				<dl>
					...
					<dd>
						...
						<input type="password" name="pwd" size="35" id="pwd"
			...
			<div id="bbsCreated_footer">
				...
				onclick="javascript:location.href='/WebApp20/List.jsp?pageNum=<%=pageNum%>'">
