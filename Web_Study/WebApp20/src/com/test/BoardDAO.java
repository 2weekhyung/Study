...
public class BoardDAO
{
	...
	*/
	...
	public List<BoardDTO> getLists(int start, int end)
	{
		...
		try
		{
			sql = "SELECT NUM, NAME, SUBJECT, HITCOUNT, CREATED FROM ( SELECT ROWNUM RNUM,  DATA.* FROM (SELECT NUM, NAME, SUBJECT, HITCOUNT, TO_CHAR(CREATED, 'YYYY-MM-DD') AS CREATED FROM TBL_BOARD ORDER BY NUM DESC) DATA)  WHERE RNUM BETWEEN ? AND ?";
	...
	*/
	...
	// 특정 게시물의 이전 게시물의 번호를 얻어오는 메소드 정의
	...
	// 특정 게시물의 다음 게시물의 번호를 얻어오는 메소드 정의
