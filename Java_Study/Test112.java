 ...
 class Rect112 extends SuperTest112
 {
	...
	*/
	...
	public void calc(int w, int h)
	 ...
	 @Override				//-- 어노테이션(annotation) - metadata → JDK 1.5 자바한테 전달하는 주석
	 public void write()	// 메소드 오버라이딩(메소드 재정의) , 덮어쓰기 느낌
	 {
	...
	// 모두 완전히 일치해야 한다.
	 ...
	 /*
	  public void write(int x) -- 메소드 오버로딩(메소드 중복정의)
	 {
		System.out.println("w : " + w + ", h : " + h);
		System.out.println("사각형 - " + area);
	 }
