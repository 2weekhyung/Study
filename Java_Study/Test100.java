...
// ※ 탄생 시점~!!!	-- 클래스 변수와 인스턴스 변수가 있다면 static 이 먼저 만들어짐
// ※ 공유~!!!
// staic 정적 변수 정적 메소드 라고 부르기도 함

// 실습 편의상 접근 제어지시자 생략
/*
class Pr
{
	// int n;	클래스에 선언 했으니까 클래스 변수~??? X
	// static 이 붙어있는 변수만 클래스 변수라고 함
	
	// int n; 멤버 변수, 전역 변수, 인스턴스 변수

	// static int a; -- 클래스 변수 이면서 멤버 변수, 전역 변수는 맞지만 ※ 인스턴스 변수는 아님
}
*/
...
{	
	...
	static void print()		//-- static 메소드(클래스 메소드, class 메소드, 정적 메소드)
	{
		...
		//System.out.println("클래스 메소드 → 클래스   변수 b: " + b);	// check
		//--==>> 에러 발생(컴파일 에러)
		//       아직 안태어난 동생을 부른 느낌
	...
	public static void main(String[] args)
	{
		...
		ob2.write();		// 스태틱은 스테이플러의 개념이라 공유된다
		//--==>> ob2 확인 --------------
