...
○ 배열의 개요
   ...
   1. 자바에서 배열이란 크기와 성격이 같은 일련의 원소들이 모여
   	  공동의 집하 구조를 갖는 자료의 잡함체를 의미하는 것으로
...
public class Test079
{
	...
	{	
		...
		//	  비어있는 것이 아니라 자동으로 초기화 된다. → 0 (int 형 배열)
		int num = 10;
		...
		for (int i=0; i<10; i++)	// 배열을 반복문을 사용할때는 루프 변수를 0으로 초기화, 이퀄(등호 =) 사용하지 않는 것이 일반적
		{	
			// 테스트
