...
○ 개요
   ...
   효율적으로 작성할 수 있도록 자바 표준 피키지를 제공하며
 ...
 ○ import구문
	...
	imprt 되어 있기 때문에 이 패키지의 클래스들은 import 하지 않고
	바로 사용하는 것이 가능하다.

	imprort 문은 반드시 클래스 설계 구문 전에 선언되어 있어야 하며
	형식은 다음과 같은 두 가지가 있다.
...
{	
	...
	*/
	...
	public static void main(String[] args)
	{
		...
		//객체.xxx();
		//-- 해당 객체를 생성시키는데 사용된 클래스 메소드 xxx() 호출

		// Circel ob = new Circle();
		// ob.input();
